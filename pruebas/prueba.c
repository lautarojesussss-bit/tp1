...
void prueba_tp1_leer_algo()
{
        ...
        pa2m_afirmar(tp != NULL, "Se logró leer algo a partir del archivo %s que tiene 1 pokemon con formato válido.", ARCHIVO_UN_POKEMON);
}
...
void prueba_tp1_leer_cantidad_correcta()
{
        ...
        pa2m_afirmar(tp->cantidad == CANT_LEIDA_ESPERADA, "Se logró leer la cantidad esperada de pokemones.");
}
...
void prueba_tp1_leer_todo_bien()
{
        ...
        pa2m_afirmar(son_iguales_los_tp(&tp_correcto, tp_aux), "Se logró leer correctamente el pokemon %s del archivo %s", tp_correcto.pokemones[1]->nombre, ARCHIVO_UN_POKEMON);
}